  ...
  return (
    <div className="flex items-center justify-center mt-8">
      <div className="bg-gray-100 rounded-lg shadow-sm p-6 w-80 flex flex-col items-center justify-center">
        ...
        <p className="text-gray-500 mb-2">@{currentUser.name}</p>
        <p className="text-gray-500">Total study/stream time: 69</p>
        <div className="mt-4">
          <h3 className="text-lg font-semibold mb-2">Bio</h3>
          <p className="text-gray-600">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris
            pretium urna vel nisi posuere blandit. Vestibulum id feugiat sapien,
            eget euismod elit.
          </p>
        </div>
        <div className="mt-4">
          <h3 className="text-lg font-semibold mb-2">Interests/Hobbies</h3>
          <p className="text-gray-600">Reading, hiking, coding, photography</p>
        </div>
        <div className="mt-4">
